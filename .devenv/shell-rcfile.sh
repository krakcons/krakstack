...
source "/Users/billyhawkes/Projects/krakstack/apps/site/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/var/folders/_l/vtd2s5px4gj5w0msf57_7bdr0000gn/T/devenv-reload-85735.sh" ]; then
        ...
        source "/var/folders/_l/vtd2s5px4gj5w0msf57_7bdr0000gn/T/devenv-reload-85735.sh"
        rm -f "/var/folders/_l/vtd2s5px4gj5w0msf57_7bdr0000gn/T/devenv-reload-85735.sh"
