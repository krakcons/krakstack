...
out='/nix/store/d33wxh0vxjhrxf9bsm76sshakr51zfw3-devenv-shell-env'
export out
IN_NIX_SHELL='impure'
export IN_NIX_SHELL
NIX_STORE='/nix/store'
...
prefix='/nix/store/d33wxh0vxjhrxf9bsm76sshakr51zfw3-devenv-shell-env'
...
exec /var/folders/_l/vtd2s5px4gj5w0msf57_7bdr0000gn/T/devenv-env5ktSKs/script 