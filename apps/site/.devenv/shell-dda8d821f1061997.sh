...
outputDoc='out'
out='/nix/store/kaisqz3rc4rlk53p7wgfbaygmsbxjdpd-devenv-shell-env'
export out
cmakeFlags=''
export cmakeFlags
...
prefix='/nix/store/kaisqz3rc4rlk53p7wgfbaygmsbxjdpd-devenv-shell-env'
...
exec /var/folders/_l/vtd2s5px4gj5w0msf57_7bdr0000gn/T/devenv-envCVQwWg/script 