...
const DocsArticle = ({
  ...
  let remainingHtml = page.html;

  page.codeBlocks.forEach((block, index) => {
    const marker = `<docs-code-block data-index="${index}"></docs-code-block>`;
