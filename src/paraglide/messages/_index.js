...
/** @typedef {{}} Krakstack_Package_Auth_Overview_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_OverviewInputs */
/** @typedef {{}} Krakstack_Package_Auth_Components_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_Components_DescriptionInputs */
/** @typedef {{}} Krakstack_Package_Auth_Forms_TitleInputs */
/** @typedef {{}} Krakstack_Package_Auth_Forms_DescriptionInputs */
/** @typedef {{}} Krakstack_Package_Auth_User_Button_TitleInputs */
/** @typedef {{}} Krakstack_Package_Auth_User_Button_DescriptionInputs */
/** @typedef {{}} Krakstack_Package_Auth_Org_Switcher_TitleInputs */
/** @typedef {{}} Krakstack_Package_Auth_Org_Switcher_DescriptionInputs */
/** @typedef {{}} Krakstack_Package_Auth_Member_Required_TitleInputs */
/** @typedef {{}} Krakstack_Package_Auth_Member_Required_DescriptionInputs */
/** @typedef {{}} Krakstack_Package_Auth_Admin_TitleInputs */
/** @typedef {{}} Krakstack_Package_Auth_Admin_DescriptionInputs */
/** @typedef {{}} Krakstack_Package_Auth_Provider_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_ProviderInputs */
/** @typedef {{}} Krakstack_Package_Auth_Component_Usage_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_Component_UsageInputs */
/** @typedef {{}} Krakstack_Package_Auth_Middleware_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_MiddlewareInputs */
/** @typedef {{}} Krakstack_Package_Auth_Clients_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_ClientsInputs */
/** @typedef {{}} Krakstack_Package_Auth_Preview_HeadingInputs */
/** @typedef {{}} Krakstack_Package_Auth_Preview_DescriptionInputs */
...
*
* @param {Krakstack_Package_Auth_Overview_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_overview_heading = /** @type {((inputs?: Krakstack_Package_Auth_Overview_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Overview_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_overview_heading(inputs)
	return __fr.krakstack_package_auth_overview_heading(inputs)
});
/**
* | output |
* | --- |
* | "`@krak-stack/auth` connects a TanStack Start application to KrakStack Auth across three boundaries: ready-made React account UI, typed Effect clients and sch..." |
*
* @param {Krakstack_Package_Auth_OverviewInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_overview = /** @type {((inputs?: Krakstack_Package_Auth_OverviewInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_OverviewInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_overview(inputs)
	return __fr.krakstack_package_auth_overview(inputs)
});
/**
* | output |
* | --- |
* | "Components" |
*
* @param {Krakstack_Package_Auth_Components_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_components_heading = /** @type {((inputs?: Krakstack_Package_Auth_Components_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Components_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_components_heading(inputs)
	return __fr.krakstack_package_auth_components_heading(inputs)
});
/**
* | output |
* | --- |
* | "Production UI for the complete account lifecycle. The forms render as focused cards; the user and organization controls render as compact dropdown triggers w..." |
*
* @param {Krakstack_Package_Auth_Components_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_components_description = /** @type {((inputs?: Krakstack_Package_Auth_Components_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Components_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_components_description(inputs)
	return __fr.krakstack_package_auth_components_description(inputs)
});
/**
* | output |
* | --- |
...
*
* @param {Krakstack_Package_Auth_Forms_TitleInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_forms_title = /** @type {((inputs?: Krakstack_Package_Auth_Forms_TitleInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Forms_TitleInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_forms_title(inputs)
	return __fr.krakstack_package_auth_forms_title(inputs)
});
/**
* | output |
* | --- |
* | "Signin is a responsive card form for password sign-in, email-code account creation and sign-in, and Google sign-in. ResetPassword handles both the email requ..." |
*
* @param {Krakstack_Package_Auth_Forms_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_forms_description = /** @type {((inputs?: Krakstack_Package_Auth_Forms_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Forms_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_forms_description(inputs)
	return __fr.krakstack_package_auth_forms_description(inputs)
});
/**
* | output |
* | --- |
* | "User Button" |
*
* @param {Krakstack_Package_Auth_User_Button_TitleInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_user_button_title = /** @type {((inputs?: Krakstack_Package_Auth_User_Button_TitleInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_User_Button_TitleInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_user_button_title(inputs)
	return __fr.krakstack_package_auth_user_button_title(inputs)
});
/**
* | output |
* | --- |
* | "An avatar trigger opens account, security, API-key, and sign-out actions. Its dialogs cover profile photos, linked accounts, passwords, two-factor setup, and..." |
*
* @param {Krakstack_Package_Auth_User_Button_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_user_button_description = /** @type {((inputs?: Krakstack_Package_Auth_User_Button_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_User_Button_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_user_button_description(inputs)
	return __fr.krakstack_package_auth_user_button_description(inputs)
});
/**
* | output |
* | --- |
...
*
* @param {Krakstack_Package_Auth_Org_Switcher_TitleInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_org_switcher_title = /** @type {((inputs?: Krakstack_Package_Auth_Org_Switcher_TitleInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Org_Switcher_TitleInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_org_switcher_title(inputs)
	return __fr.krakstack_package_auth_org_switcher_title(inputs)
});
/**
* | output |
* | --- |
* | "A workspace trigger opens organization selection and management. Users can create organizations, edit localized profiles, manage members and invitations, and..." |
*
* @param {Krakstack_Package_Auth_Org_Switcher_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_org_switcher_description = /** @type {((inputs?: Krakstack_Package_Auth_Org_Switcher_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Org_Switcher_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_org_switcher_description(inputs)
	return __fr.krakstack_package_auth_org_switcher_description(inputs)
});
/**
* | output |
* | --- |
* | "Member Required" |
*
* @param {Krakstack_Package_Auth_Member_Required_TitleInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_member_required_title = /** @type {((inputs?: Krakstack_Package_Auth_Member_Required_TitleInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Member_Required_TitleInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_member_required_title(inputs)
	return __fr.krakstack_package_auth_member_required_title(inputs)
});
/**
* | output |
* | --- |
* | "An organization access gate. It renders children for members, offers pending invitations for acceptance, and otherwise shows a localized contact state instea..." |
*
* @param {Krakstack_Package_Auth_Member_Required_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_member_required_description = /** @type {((inputs?: Krakstack_Package_Auth_Member_Required_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Member_Required_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_member_required_description(inputs)
	return __fr.krakstack_package_auth_member_required_description(inputs)
});
/**
* | output |
* | --- |
* | "Admin UI" |
*
* @param {Krakstack_Package_Auth_Admin_TitleInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_admin_title = /** @type {((inputs?: Krakstack_Package_Auth_Admin_TitleInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Admin_TitleInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_admin_title(inputs)
	return __fr.krakstack_package_auth_admin_title(inputs)
});
/**
* | output |
* | --- |
* | "AdminUsersTable, AdminOrganizationsTable, and AdminOrganizationForm provide searchable management tables, user impersonation controls, and organization creat..." |
*
* @param {Krakstack_Package_Auth_Admin_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_admin_description = /** @type {((inputs?: Krakstack_Package_Auth_Admin_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Admin_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_admin_description(inputs)
	return __fr.krakstack_package_auth_admin_description(inputs)
});
/**
* | output |
* | --- |
* | "Provider setup" |
*
* @param {Krakstack_Package_Auth_Provider_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_provider_heading = /** @type {((inputs?: Krakstack_Package_Auth_Provider_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Provider_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_provider_heading(inputs)
	return __fr.krakstack_package_auth_provider_heading(inputs)
});
/**
* | output |
* | --- |
* | "`KrakstackAuthProvider` is the recommended root application boundary. It creates or accepts the Better Auth client, resolves the public project configuration..." |
*
* @param {Krakstack_Package_Auth_ProviderInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_provider = /** @type {((inputs?: Krakstack_Package_Auth_ProviderInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_ProviderInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_provider(inputs)
	return __fr.krakstack_package_auth_provider(inputs)
});
/**
* | output |
* | --- |
* | "Component usage" |
*
* @param {Krakstack_Package_Auth_Component_Usage_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_component_usage_heading = /** @type {((inputs?: Krakstack_Package_Auth_Component_Usage_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Component_Usage_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_component_usage_heading(inputs)
	return __fr.krakstack_package_auth_component_usage_heading(inputs)
});
/**
* | output |
* | --- |
* | "Both dropdown components support controlled dialogs, custom unauthenticated rendering, localized message overrides, and explicit client props. OrganizationSw..." |
*
* @param {Krakstack_Package_Auth_Component_UsageInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_component_usage = /** @type {((inputs?: Krakstack_Package_Auth_Component_UsageInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Component_UsageInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_component_usage(inputs)
	return __fr.krakstack_package_auth_component_usage(inputs)
});
/**
* | output |
* | --- |
* | "Effect middleware" |
*
* @param {Krakstack_Package_Auth_Middleware_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_middleware_heading = /** @type {((inputs?: Krakstack_Package_Auth_Middleware_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Middleware_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_middleware_heading(inputs)
	return __fr.krakstack_package_auth_middleware_heading(inputs)
});
/**
* | output |
* | --- |
* | "The server export provides an `AuthMiddleware` for HttpApi groups secured by the `x-api-key` header. A successful check provides `AuthService` to every endpo..." |
*
* @param {Krakstack_Package_Auth_MiddlewareInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_middleware = /** @type {((inputs?: Krakstack_Package_Auth_MiddlewareInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_MiddlewareInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_middleware(inputs)
	return __fr.krakstack_package_auth_middleware(inputs)
});
/**
* | output |
* | --- |
...
*
* @param {Krakstack_Package_Auth_Clients_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_clients_heading = /** @type {((inputs?: Krakstack_Package_Auth_Clients_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Clients_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_clients_heading(inputs)
	return __fr.krakstack_package_auth_clients_heading(inputs)
});
/**
* | output |
* | --- |
* | "Use `AuthService` for Effect programs, the exported API groups for typed HttpApi composition, and `Query`, `Roles`, or the schema subpath for shared user, or..." |
*
* @param {Krakstack_Package_Auth_ClientsInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_clients = /** @type {((inputs?: Krakstack_Package_Auth_ClientsInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_ClientsInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_clients(inputs)
	return __fr.krakstack_package_auth_clients(inputs)
});
/**
* | output |
* | --- |
...
*
* @param {Krakstack_Package_Auth_Preview_HeadingInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_preview_heading = /** @type {((inputs?: Krakstack_Package_Auth_Preview_HeadingInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Preview_HeadingInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_preview_heading(inputs)
	return __fr.krakstack_package_auth_preview_heading(inputs)
});
/**
* | output |
* | --- |
...
*
* @param {Krakstack_Package_Auth_Preview_DescriptionInputs} inputs
* @param {{ locale?: "en" | "fr" }} options
* @returns {LocalizedString}
*/
export const krakstack_package_auth_preview_description = /** @type {((inputs?: Krakstack_Package_Auth_Preview_DescriptionInputs, options?: { locale?: "en" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Krakstack_Package_Auth_Preview_DescriptionInputs, { locale?: "en" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return __en.krakstack_package_auth_preview_description(inputs)
	return __fr.krakstack_package_auth_preview_description(inputs)
});
/**
* | output |
* | --- |
...
* | output |
* | --- |
* | "Provider, middleware, account forms, organization controls, and user management UI from the KrakStack Auth package." |
*
