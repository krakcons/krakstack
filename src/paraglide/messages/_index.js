...
* | output |
* | --- |
* | "Signin and Signup are responsive card forms for password, email-code, and Google flows. ResetPassword handles token-based password recovery, while TwoFactor ..." |
*
